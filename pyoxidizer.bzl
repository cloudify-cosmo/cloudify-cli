...
def make_exe():
    ...
    python_config.run_command = "from cloudify_cli.main import _cfy; _cfy()"
    ...
    # attributes.
    #exe.add_python_resources(exe.pip_install(["aiohttp"]))
    exe.add_python_resources(exe.pip_install(["click>7,<8",
                                              "wagon[venv]>=0.10.1",
                                              "jinja2==2.11.3",
                                              "retrying==1.3.3",
                                              "colorama==0.4.4",
    ...
    exe.add_python_resources(exe.pip_install(["-r", "dev-requirements.txt"]))
