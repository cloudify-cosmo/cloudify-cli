...
function download_wheels() {
    ...
    https://github.com/cloudify-cosmo/cloudify-script-plugin/archive/1.5.4.zip#egg=cloudify-script-plugin \
...
function download_resources() {
    ...
    pushd packaging/source/plugins
        ...
        curl -L https://raw.githubusercontent.com/cloudify-cosmo/cloudify-script-plugin/1.5.4/plugin.yaml -o script-plugin/plugin.yaml
