...
#    pip wheel --wheel-dir packaging/source/wheels --find-links packaging/source/wheels C:/Cygwin/home/Administrator/cloudify-cli-${CORE_BRANCH}.zip \
    ...
    zip -q -r cloudify-cli-fix-osx-build.zip cloudify-cli-fix-osx-build
    [[ $? -eq 0 ]] && rm -rf cloudify-cli-fix-osx-build

    pip wheel --wheel-dir packaging/source/wheels --find-links packaging/source/wheels C:/Cygwin/home/Administrator/cloudify-cli-fix-osx-build.zip \
