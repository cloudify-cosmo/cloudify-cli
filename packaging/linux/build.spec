...
curl http://cloudify-public-repositories.s3.amazonaws.com/cloudify-manager-blueprints/3.3.1-sec1/cloudify-manager-blueprints.tar.gz -o /tmp/cloudify-manager-blueprints.tar.gz &&
...
pip wheel git+https://github.com/cloudify-cosmo/cloudify-plugins-common@3.3.1-sec1 --wheel-dir=%{buildroot}/var/wheels/%{name} --find-links=%{buildroot}/var/wheels/%{name} &&
...
pip wheel git+https://github.com/cloudify-cosmo/cloudify-cli@3.3.1-sec1 --wheel-dir=%{buildroot}/var/wheels/%{name} --find-links=%{buildroot}/var/wheels/%{name} &&
...
curl https://raw.githubusercontent.com/cloudify-cosmo/cloudify-manager/3.3.1-sec1/resources/rest-service/cloudify/fs/mkfs.sh -o %{buildroot}/opt/cfy/cloudify/scripts/mkfs.sh
curl https://raw.githubusercontent.com/cloudify-cosmo/cloudify-manager/3.3.1-sec1/resources/rest-service/cloudify/fs/fdisk.sh -o %{buildroot}/opt/cfy/cloudify/scripts/fdisk.sh
curl https://raw.githubusercontent.com/cloudify-cosmo/cloudify-manager/3.3.1-sec1/resources/rest-service/cloudify/fs/mount.sh -o %{buildroot}/opt/cfy/cloudify/scripts/mount.sh
curl https://raw.githubusercontent.com/cloudify-cosmo/cloudify-manager/3.3.1-sec1/resources/rest-service/cloudify/fs/unmount.sh -o %{buildroot}/opt/cfy/cloudify/scripts/unmount.sh
curl https://raw.githubusercontent.com/cloudify-cosmo/cloudify-manager/3.3.1-sec1/resources/rest-service/cloudify/policies/host_failure.clj -o %{buildroot}/opt/cfy/cloudify/scripts/host_failure.clj
curl https://raw.githubusercontent.com/cloudify-cosmo/cloudify-manager/3.3.1-sec1/resources/rest-service/cloudify/policies/threshold.clj -o %{buildroot}/opt/cfy/cloudify/scripts/threshold.clj
curl https://raw.githubusercontent.com/cloudify-cosmo/cloudify-manager/3.3.1-sec1/resources/rest-service/cloudify/policies/ewma_stabilized.clj -o %{buildroot}/opt/cfy/cloudify/scripts/ewma_stabilized.clj
curl https://raw.githubusercontent.com/cloudify-cosmo/cloudify-manager/3.3.1-sec1/resources/rest-service/cloudify/triggers/execute_workflow.clj -o %{buildroot}/opt/cfy/cloudify/scripts/execute_workflow.clj
